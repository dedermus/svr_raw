...
use Svr\ImportRaw\Models\FromSelexMilk;
...
class FromSelexMilkController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->date('DATE_ROGD', __('DATE_ROGD'))->help(trans('svr.date_rogd'))->rules('date: Y-m-d|nullable', ['data' => trans('svr.validation.data')]);
        $form->date('DATE_POSTUPLN', __('DATE_POSTUPLN'))->help(trans('svr.date_postupln'))->rules('date: Y-m-d|nullable', ['data' => trans('svr.validation.data')]);
        ...
        $form->date('DATE_V', __('DATE_V'))->help(trans('svr.date_v'))->rules('date: Y-m-d|nullable', ['data' => trans('svr.validation.data')]);
        ...
        $form->date('DATE_CHIP', __('DATE_CHIP'))->help(trans('svr.date_chip'))->rules('date: Y-m-d|nullable', ['data' => trans('svr.validation.data')]);
        $form->date('DATE_NINV', __('DATE_NINV'))->help(trans('svr.date_ninv'))->rules('date: Y-m-d|nullable', ['data' => trans('svr.validation.data')]);
        $form->date('DATE_NGOSREGISTER', __('DATE_NGOSREGISTER'))->help(trans('svr.date_ngosregister'))->rules('date: Y-m-d|nullable', ['data' => trans('svr.validation.data')]);
        ...
        $form->date('DATE_ROGD_OTCA', __('DATE_ROGD_OTCA'))->help(trans('svr.date_rogd_otca'))->rules('date: Y-m-d|nullable', ['data' => trans('svr.validation.data')]);
        ...
        $form->date('DATE_ROGD_MATERI', __('DATE_ROGD_MATERI'))->help(trans('svr.date_rogd_materi'))->rules('date: Y-m-d|nullable', ['data' => trans('svr.validation.data')]);
