...
class FromSelexBeefController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->date('DATE_ROGD', __('DATE_ROGD'))->help(trans('svr.date_rogd'))->rules('data|nullable', ['data' => trans('validation.data')]);
        $form->date('DATE_POSTUPLN', __('DATE_POSTUPLN'))->help(trans('svr.date_postupln'))->rules('data|nullable', ['data' => trans('validation.data')]);
        ...
        $form->date('DATE_V', __('DATE_V'))->help(trans('svr.date_v'))->rules('data|nullable', ['data' => trans('validation.data')]);
        ...
        $form->date('DATE_CHIP', __('DATE_CHIP'))->help(trans('svr.date_chip'))->rules('data|nullable', ['data' => trans('validation.data')]);
        $form->date('DATE_NINV', __('DATE_NINV'))->help(trans('svr.date_ninv'))->rules('data|nullable', ['data' => trans('validation.data')]);
        $form->date('DATE_NGOSREGISTER', __('DATE_NGOSREGISTER'))->help(trans('svr.date_ngosregister'))->rules('data|nullable', ['data' => trans('validation.data')]);
        ...
        $form->date('DATE_ROGD_OTCA', __('DATE_ROGD_OTCA'))->help(trans('svr.date_rogd_otca'))->rules('data|nullable', ['data' => trans('validation.data')]);
        ...
        $form->date('DATE_ROGD_MATERI', __('DATE_ROGD_MATERI'))->help(trans('svr.date_rogd_materi'))->rules('data|nullable', ['data' => trans('validation.data')]);
